...
public class InfoManager : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI nameTxt, hpTxt, rsrcTxt,
        moveTxt, atkTxt, amrTxt, vslRngTxt, wpRngTxt;
    ...
    public void ShowAllInfo(Units unit)
    {
        SetPic(unit.UnitPic);
    ...
    public void ShowEnemyAllInfo(Units unit)
    {
        SetPic(unit.UnitPic);
        nameTxt.text = unit.UnitName;
