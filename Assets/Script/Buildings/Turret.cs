...
public class Turret : Building
{
    ...
    protected Units CheckForNearbyEnemies()
    {
        ...
        for (int x = 0; x < hits.Length; x++)
        {
            ...
            Units target = hits[x].collider.GetComponent<Units>();// skip if this is not a unit or if it is a corpse
        ...
        if (closest != null)
        {
            ...
            return closest.GetComponent<Units>();
        }
        else
            return null;
    }
    protected void ShootAtEnemy()
    {
        if (targetUnit != null)
        {
            Units u = targetUnit.GetComponent<Units>();
    ...
    private void CheckForAttack()
    {
        ...
        Units enemyUnit = CheckForNearbyEnemies();
